...
export const STORY_PASSAGES: Record<string, Passage> = {
  ...
  abandoned_shack: {
    ...
    icon: '',
    onEnterMutations: [
      { type: 'inventory', action: 'add', itemId: 'Torch' },
      { type: 'inventory', action: 'add', itemId: 'Wood', count: { type: 'literal', value: 2 }, isMaterial: true },
    ],
    ...
    choices: [
      ...
      },
      {
        ...
        condition: {
          type: 'binary',
          op: '>=',
          left: { type: 'get', path: 'game.sandbox.forestCleared' },
  ...
  spider_nest_cleared: {
    ...
    icon: '',
    onEnterMutations: [
      { type: 'inventory', action: 'add', itemId: 'String', count: { type: 'literal', value: 3 }, isMaterial: true },
      { type: 'inventory', action: 'add', itemId: 'Leather', count: { type: 'literal', value: 2 }, isMaterial: true },
    ],
    accessibleViews: ['forest'],
    choices: [
      {
  ...
  witch_spoils: {
    ...
    icon: '',
    onEnterMutations: [
      { type: 'inventory', action: 'add', itemId: 'Gunpowder', count: { type: 'literal', value: 3 }, isMaterial: true },
      { type: 'inventory', action: 'add', itemId: 'Slimeball', count: { type: 'literal', value: 2 }, isMaterial: true },
    ],
    choices: [
      {
    ...
    choices: [
      ...
      },
      {
        ...
        condition: {
          type: 'binary',
          op: '>=',
          left: { type: 'get', path: 'hero.materials.Wood' },
          right: { type: 'literal', value: 3 },
        },
        mutations: [
          { type: 'inventory', action: 'remove', itemId: 'Wood', count: { type: 'literal', value: 3 }, isMaterial: true },
        ],
  ...
  dungeon_gate: {
    ...
    choices: [
      ...
      },
      {
        ...
        mutations: [
          { type: 'inventory', action: 'remove', itemId: 'TNT' },
        ],
  ...
  vault_room: {
    ...
    onEnterMutations: [
      ...
      { type: 'inventory', action: 'add', itemId: 'Diamond', count: { type: 'literal', value: 3 }, isMaterial: true },
      { type: 'inventory', action: 'add', itemId: 'Iron', count: { type: 'literal', value: 3 }, isMaterial: true },
    ],
    accessibleViews: ['crafting'],
    choices: [
      {
  ...
  drowned_spoils: {
    ...
    icon: '',
    onEnterMutations: [
      { type: 'inventory', action: 'add', itemId: 'Iron', count: { type: 'literal', value: 2 }, isMaterial: true },
