...
export const STORY_PASSAGES: Record<string, Passage> = {
  ...
  witch_spoils: {
    ...
    icon: 'spark',
    autoGrant: {
      materials: { Gunpowder: 3, Slimeball: 2 },
      healthDelta: 4,
  ...
  lava_chamber: {
    ...
    choices: [
      ...
      },
      {
        ...
        requiresMaterial: { material: 'Wood', count: 3 },
        consumeMaterial: { material: 'Wood', count: 3 },
        targetPassageId: 'dungeon_gate',
      },
      {
  ...
  vault_room: {
    ...
    icon: 'spark',
    autoGrant: {
      equipment: ['Totem of Undying'],
      materials: { Diamond: 3, Iron: 3 },
  ...
  drowned_spoils: {
    ...
    icon: 'spark',
    autoGrant: {
      materials: { Iron: 2, Fish: 3, Leather: 2 },
